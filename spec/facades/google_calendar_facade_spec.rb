...
RSpec.describe GoogleCalendarFacade do
  ...
  describe "initialize" do
    it "holds a User's mod", :vcr do
      expect(google_calendar_facade).to be_a(GoogleApiFacade)
  ...
  describe "#find_thumbnail_url" do
    let(:slides_facade){GoogleApiFacade.new({access_token: "ya29.a0Ad52N3_XTssX0q0K53xI8JgVEtndBsHn9i-a5l5VW1T-UBOiMd8FNG1oIfl-5XqBor1Ad-3DD250QfRpjthJWzWUW1x6TQeAs5Ah29VVi98aP3gwHRahwRPkvYkfFOLN6qwqN5lk7zwtSN-5oUdFjMT6n45swGRQDfNqaCgYKAScSARISFQHGX2MiNEtjUg72mTwW7TLlzFczlQ0171"})}
